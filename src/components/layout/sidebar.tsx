...
export function Sidebar() {
  ...
  return <aside className="w-64 shrink-0 border-r border-zinc-200 bg-white min-h-screen p-4 flex flex-col">
    <div className="px-3 py-4 mb-5"><div className="font-bold tracking-tight text-xl">◈ VaultFoundry</div><div className="text-xs text-zinc-500 mt-1">Email foundry</div></div>
